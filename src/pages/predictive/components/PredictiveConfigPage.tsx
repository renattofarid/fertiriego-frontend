...
export default function PredictiveConfigPage() {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="rounded-xl border p-4 space-y-4">
            ...
            <FormInput
              ...
              type="number"
              placeholder="Dejar vacío para configuración global"
              description="Si se indica un ID de producto, la configuración aplica solo a ese producto. Vacío = configuración global."
              optional
            />
          </div>
