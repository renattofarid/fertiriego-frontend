...
interface PurchaseShippingGuideStore {
  ...
  updateGuide: (id: number, data: Partial<PurchaseShippingGuideUpdateSchema>) => Promise<void>;
  removeGuide: (id: number) => Promise<void>;
  assignPurchaseToGuide: (id: number, purchaseId: number) => Promise<void>;
  resetGuide: () => void;
}

export const usePurchaseShippingGuideStore = create<PurchaseShippingGuideStore>((set) => ({
  // Initial state
  allGuides: null,
  guides: null,
  guide: null,
  ...
  // Update guide
  updateGuide: async (id: number, data: Partial<PurchaseShippingGuideUpdateSchema>) => {
    set({ isSubmitting: true, error: null });
    try {
      const request: UpdatePurchaseShippingGuideRequest = {
        ...
        ...(data.destination_address && { destination_address: data.destination_address }),
